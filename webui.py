...
CMD_FLAGS = '--chat --character Chiharu_Yamada --loader exllama_hf --disk --model anon8231489123_vicuna-13b-GPTQ-4bit-128g --auto-devices --n-gpu-layers 200000 --auto-launch --listen --api'
